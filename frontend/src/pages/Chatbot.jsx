...
const MOCK_RESPONSES = [
  "Based on your policy, pre-hospitalization expenses are covered for 30 days before admission.",
  "Your policy has a room rent capping of 1% of the sum insured per day. Exceeding this may result in proportionate deductions.",
  "Maternity benefits kick in after a 9-month waiting period. Normal delivery is covered up to ₹50,000.",
  "Day-care procedures listed in your policy include cataract surgery, chemotherapy, and dialysis.",
];
...
export default function Chatbot() {
  ...
  const sendMessage = () => {
    ...
    setTimeout(() => {
      ...
      mockIdx++;
      const aiMsg = { id: Date.now() + 1, role: 'ai', content: reply, time: now() };
      setIsTyping(false);
